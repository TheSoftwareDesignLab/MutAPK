package edu.uniandes.tsdl.mutapk.operators.db.android;
...
public class ClosingNullCursor implements MutationOperator {
	...
	public boolean performMutation(MutationLocation location, BufferedWriter writer, int mutantIndex) throws Exception {
		...
		writer.write("	For mutant "+mutantIndex+" Database cursor at line "+mLocation.getLine()+" has been set to null before close() call");
		writer.newLine();
		writer.flush();
		return true;
